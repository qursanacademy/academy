...
const LinuxCoursesPage = () => {
  const courses = [
    {
      title: 'أساسيات نظام لينكس',
      description: 'دورة شاملة في أساسيات نظام لينكس للمبتدئين، تشرح أهم الأوامر والمهارات الأساسية للتعامل مع النظام.',
      link: 'https://www.youtube.com/watch?v=ZVAddIMB3mg&list=PLDRMxi70CdSD48OPJbsDZRt4l0GvWJ2iG',
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg">
              دورات عربية متميزة لتعلم نظام لينكس من الصفر حتى الاحتراف.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionTitle 
            title="دورات لينكس" 
            subtitle="أفضل الدورات العربية لإتقان نظام لينكس."
            glowColor="green"
          />
...
export default LinuxCoursesPage;
