import { Code, ExternalLink, Youtube, BookOpen } from 'lucide-react';
  ...
  const resources = [
    {
      ...
      description: 'موقع عربي شامل لتعلم البرمجة من الصفر مع دورات مجانية ومدفوعة في لغات متعددة.',
    ...
    },
    {
      ...
      description: 'بايثون للأمن السيبراني وبناء أدوات الاختراق من المهندس راكوان - دورة متخصصة لتعلم كتابة أدوات الأمن السيبراني.',
      link: 'https://www.youtube.com/watch?v=KMOS1aPgpgo&list=PLQecpJ5wKrfsF7mZVJxvy53I7FimkGxzZ',
      icon: <Code className="w-6 h-6" />,
      type: 'سلسلة يوتيوب',
    },
    {
      title: 'أساسيات لغة Python',
      description: 'دورة بايثون المقدمة من المهندس أسامة الزيرو - دورة شاملة لتعلم أساسيات لغة بايثون من الصفر.',
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg">
              تعلم أساسيات البرمجة وبايثون للأمن السيبراني. البرمجة هي أساس فهم كيفية عمل الأنظمة واكتشاف الثغرات.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionTitle 
            title="مصادر التعلم" 
            subtitle="مجموعة منتقاة من أفضل المصادر لتعلم البرمجة باللغة العربية."
            glowColor="green"
          />
