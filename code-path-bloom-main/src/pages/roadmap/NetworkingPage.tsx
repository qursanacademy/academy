import { Network, ExternalLink, Youtube } from 'lucide-react';
...
const NetworkingPage = () => {
  const resources = [
    {
      title: 'دورة Network+ - المهندس سامح رمضان',
      description: 'دورة شاملة لشهادة CompTIA Network+ باللغة العربية. تغطي أساسيات الشبكات ونموذج OSI وبروتوكولات TCP/IP.',
      link: 'https://www.youtube.com/watch?v=RFK4Kc_aJYg&list=PLH-n8YK76vIiuIZoWvHL7AvtrDV7hR3He',
      icon: <Youtube className="w-6 h-6" />,
      type: 'سلسلة يوتيوب',
    },
    {
      title: 'دورة CCNA المقدمة من NetworkChuck',
      description: 'اساسيات شهادة ال CCNA المقدمة من networkchuck دروة جميلة ومفيدة جدا قبل التعمق في الشبكات ومفيدة للامن السيبراني',
      link: 'https://www.youtube.com/watch?v=S7MNX_UD7vY&list=PLIhvC56v63IJVXv0GJcl9vO5Z6znCVb1P',
      icon: <Youtube className="w-6 h-6" />,
      type: 'سلسلة يوتيوب',
    },
    {
      title: 'دورة CCNA– م. وليد سعد الدين',
      description: 'دورة قوية ومبسطة في الشبكات، يقدمها المهندس وليد سعد الدين، مناسبة للمبتدئين لفهم المفاهيم الأساسية قبل الدخول لمجال الأمن السيبراني',
      link: 'https://www.youtube.com/watch?v=JaLlJ2hUXC8&list=PLLlr6jKKdyK2cNjQnBcSfGab2k9KNsUmg',
      icon: <Youtube className="w-6 h-6" />,
      type: 'سلسلة يوتيوب',
    },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-muted-foreground text-lg">
              فهم أساسيات الشبكات ضروري لأي متخصص في الأمن السيبراني. تعلم TCP/IP، نموذج OSI، والبروتوكولات الأساسية.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <SectionTitle
            title="مصادر التعلم"
            subtitle="دورات عربية متميزة لتعلم الشبكات من الصفر حتى الاحتراف."
            glowColor="green"
          />
